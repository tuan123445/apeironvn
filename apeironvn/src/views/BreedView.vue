<template>
  ...
  <main class="body-wrapper breed-view">
    ...
    <div class="section-six">
      <h1>Breed?</h1>
      <h2 class="apeiron-font">abcdefghiklm</h2>
    ...
    return {
      ...
      planets: [
        ...
        },
        {
          ...
          value: 5,
          link: ArchipelagoImg,
          legacy: index.lib.legacy.Archipelago,
          haveFire: false,
          haveWater: true,
          haveAir: false,
          haveEarth: true,
        },
        {
          ...
          value: 6,
          link: VolcanicImg,
          legacy: index.lib.legacy.Volcanic,
          haveFire: true,
          haveWater: false,
          haveAir: false,
          haveEarth: true,
        },
        {
          ...
          value: 7,
          link: KarstImg,
          legacy: index.lib.legacy.Karsts,
          haveFire: false,
          haveWater: false,
          haveAir: true,
          haveEarth: true,
        },
        {
          ...
          value: 8,
          link: TundraImg,
          legacy: index.lib.legacy.Tundra,
          haveFire: true,
          haveWater: true,
          haveAir: false,
          haveEarth: false,
        ...
        },
        {
          ...
          value: 11,
          link: MountainousImg,
          legacy: index.lib.legacy.Mountainous,
          haveFire: true,
          haveWater: true,
          haveAir: false,
          haveEarth: true,
        },
        {
          ...
          value: 12,
          link: ForestyImg,
          legacy: index.lib.legacy.Foresty,
          haveFire: false,
          haveWater: true,
          haveAir: false,
          haveEarth: true,
        },
        {
          ...
          value: 13,
          link: WasterlandImg,
          legacy: index.lib.legacy.Wasterland,
          haveFire: true,
          haveWater: false,
          haveAir: true,
          haveEarth: true,
        ...
        },
        {
          ...
          value: 15,
          link: NormalImg,
          legacy: index.lib.legacy.Normal,
          haveFire: true,
          haveWater: true,
          haveAir: true,
          haveEarth: true,
